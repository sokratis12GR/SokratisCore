 ...
 * SokratisCore created by sokratis12GR on 7/26/2016 12:49 PM.
 */
public class PacketSyncableObject implements IMessage {
    ...
    public PacketSyncableObject(TileSCBase tile, byte syncableIndex, boolean booleanValue, boolean updateOnReceived) {
    ...
    public PacketSyncableObject(TileSCBase tile, byte syncableIndex, byte byteValue, boolean updateOnReceived) {
        this.tilePos = tile.getPos();
        this.index = syncableIndex;
    ...
    public PacketSyncableObject(TileSCBase tile, byte syncableIndex, short shortValue, boolean updateOnReceived) {
        this.tilePos = tile.getPos();
        this.index = syncableIndex;
    ...
    public PacketSyncableObject(TileSCBase tile, byte syncableIndex, int intValue, boolean updateOnReceived) {
        this.tilePos = tile.getPos();
        this.index = syncableIndex;
    ...
    public PacketSyncableObject(TileSCBase tile, byte syncableIndex, double doubleValue, boolean updateOnReceived) {
        this.tilePos = tile.getPos();
        this.index = syncableIndex;
    ...
    public PacketSyncableObject(TileSCBase tile, byte syncableIndex, float floatValue, boolean updateOnReceived) {
        this.tilePos = tile.getPos();
        this.index = syncableIndex;
    ...
    public PacketSyncableObject(TileSCBase tile, byte syncableIndex, String stringValue, boolean updateOnReceived) {
        this.tilePos = tile.getPos();
        this.index = syncableIndex;
    ...
    public PacketSyncableObject(TileSCBase tile, byte syncableIndex, NBTTagCompound compound, boolean updateOnReceived) {
        this.tilePos = tile.getPos();
        this.index = syncableIndex;
    ...
    public PacketSyncableObject(TileSCBase tile, byte syncableIndex, Vec3I vec3I, boolean updateOnReceived) {
        this.tilePos = tile.getPos();
        this.index = syncableIndex;
        this.vec3I = vec3I;
    ...
    public PacketSyncableObject(TileSCBase tile, byte syncableIndex, long longValue, boolean updateOnReceived) {
        this.tilePos = tile.getPos();
        this.index = syncableIndex;
        ...
        public IMessage handleMessage(PacketSyncableObject message, MessageContext ctx) {
            if (ctx.side == Side.CLIENT) {
                ...
                if (tile instanceof TileSCBase) {
                    ((TileSCBase) tile).receiveSyncPacketFromServer(message);
                }
            }
            return null;
        }
